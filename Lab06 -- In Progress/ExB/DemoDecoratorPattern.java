...
public class DemoDecoratorPattern extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        // Decorate t with BorderDecorator: x = 30, y = 30, width = 100, and height 100
        t = new BorderDecorator(t, 30, 30, 100, 100);

        // Add a ColouredFrameDecorator with x = 25, y = 25, width = 110, height = 110, and thickness = 10
        t = new ColouredFrameDecorator(t, 25, 25, 110, 110, 10);

        // Add a ColouredGlassDecorator with x = 25, y = 25, width = 110, and height = 110
        t = new ColouredGlassDecorator(t, 25, 25, 110, 110);

        // Draw the decorated component on the screen
        t.draw(g);
    }
