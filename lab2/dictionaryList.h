...
public:
  ...
  //receives a dictionaryList object and returns the datumM which contains charsM and lenghtM
  
  ostream& operator <<(ostream& os, const DictionaryList &x);
  //receives a dictionnary and os 
  // returns os containing the values of keyM and charsM of the dictionnary 
  // has a newline btween entries 
